...
// Custom functions that are made available to all views
exports.utilFunctions = {
  findById: function (things, id) {
    return things.find(function (thing) {
      return thing.id === id
    })
  },
  caseFilters: function (caseListSettings, currentUser) {
    let filters = []
  ...
  caseSortAttr: function (caseListSettings) {
  ...
  caseSortDir: function (caseListSettings) {
